...
public class OrderJPanel extends javax.swing.JPanel {
    ...
    public OrderJPanel(JPanel userProcessContainer, Enterprise enterprise, OrgDirectory directory, ManufacturingOrg organization, UserAccount userAccount) {
        initComponents();
    ...
    private void populateTable() {
        ...
        for(WorkReq wr : userAccount.getWorkQueue().getWorkRequestList()){
            ArrayList<OrderInventory> inv = ((requestVaccine) wr).getInventoryPurchase();
