...
public class VaccineJPanel extends javax.swing.JPanel {
     ...
     */
    public VaccineJPanel(JPanel userProcessContainer, OrgDirectory directory, ManufacturingOrg organization, VaccineDirectory vaccineDirectory, UserAccount account, Enterprise enterprise) {
        initComponents();
    ...
    private void btnAddVaccineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddVaccineActionPerformed
        ...
        if(validate(txtName.getText(), txtScientific.getText())){
            VaccineDetails newVaccine = new VaccineDetails();
    ...
    private void iconBackMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconBackMousePressed
        ...
        ManufactureAreaJPanel manufactureAreaJPanel = new ManufactureAreaJPanel(userProcessContainer, account, organization, enterprise, system);
        //component;
        userProcessContainer.add("ManufacturingWorkAreaJPanel", manufactureAreaJPanel);
